package by.bsuir.apiserver.config;
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, RecipientListKafka>> kafkaListenerContainerFactory() {
